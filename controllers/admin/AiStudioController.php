...
- Call get_design_tokens first (tokens: --teal,--teal-dark,--orange,--green,--ink,--muted,--surface,--border,--max-w,--section-gap,--ease,--dur) + get_global_settings (phone/address). Tokens BY DEFAULT; custom hex only with user override.
- Semantic HTML5 + WCAG 2.2 AA (4.5:1, focus-visible, 44px), clamp/container queries, BEM, mobile-first 375→1024. Existing classes: content-section, info-card, process-step, faq-item, links-tile, btn/btn-primary.
