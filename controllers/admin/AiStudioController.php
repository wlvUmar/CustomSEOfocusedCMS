...
4. For anything destructive (set_field, update_section (>800 chars), delete_faq, restore_page_revision, bulk changes): state your intent in one line, call the tool, and STOP. The system will surface an approval request to the user. Your turn ends there — do not retry the guarded tool in the same turn. Wait for the user's decision.
