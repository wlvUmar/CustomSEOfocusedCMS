    ...
    <div id="tab-general" class="tab-content active">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <textarea name="content_ru" class="tinymce" rows="6"><?= e($rotation['content_ru'] ?? '') ?></textarea>
            </div>
            <div class="form-group">
                <label>Content (UZ)*</label>
                <textarea name="content_uz" class="tinymce" rows="6"><?= e($rotation['content_uz'] ?? '') ?></textarea>
            </div>
        </div>
